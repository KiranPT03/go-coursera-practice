/*
Question: Write a program which prompts the user to enter integers and stores the integers
...
func main() {
	...
	for {
		...
		number, err := strconv.Atoi(enteredNumber)
		if err != nil {
			panic(err)
		}
	...
	// Sorting int slice in decreasing order
